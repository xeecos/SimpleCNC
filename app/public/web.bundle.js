...
var _cnc = __webpack_require__(4);
...
var _cnc = __webpack_require__(8);

var _cnc2 = _interopRequireDefault(_cnc);

var _cnc3 = __webpack_require__(9);

var _cnc4 = _interopRequireDefault(_cnc3);
...
var CNC = function () {
    function CNC() {
        ...
        _cnc4.default.wasmBinary = _fs2.default.readFileSync(_path2.default.join(__dirname, _cnc2.default));
    }

    _createClass(CNC, [{
        key: "test",
        value: function test() {
            return _cnc4.default.test();
        }
    }, {
        key: "test2",
        value: function test2() {
            return _cnc4.default.test2();
        }
    }]);
...
module.exports = __webpack_require__.p + "wasm/cnc.wasm";
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'cnc.wast';
  var wasmBinaryFile = 'cnc.wasm';
  var asmjsCodeFile = 'cnc.temp.asm.js';
...
STATICTOP = STATIC_BASE + 12304;
/* global initializers */__ATINIT__.push({ func: function func() {
    __GLOBAL__sub_I_entry_cc();
  } }, { func: function func() {
    __GLOBAL__sub_I_bind_cpp();
  } });

var STATIC_BUMP = 12304;
...
var _stderr = STATICTOP;STATICTOP += 16;;var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, trackingDelegate: {}, tracking: { openFlags: { READ: 1, WRITE: 2 } }, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, handleFSError: function handleFSError(e) {
    ...
    if (typeof crypto !== 'undefined') {
      ...
      // for nodejs
      random_device = function random_device() {
        return __webpack_require__(10)['randomBytes'](1)[0];
      };
    } else {
...
if (ENVIRONMENT_IS_NODE) {
  var fs = __webpack_require__(1);var NODEJS_PATH = __webpack_require__(0);NODEFS.staticInit();
};
...
var real___GLOBAL__sub_I_entry_cc = asm["__GLOBAL__sub_I_entry_cc"];asm["__GLOBAL__sub_I_entry_cc"] = function () {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_entry_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_entry_cc = Module["__GLOBAL__sub_I_entry_cc"] = function () {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_entry_cc"].apply(null, arguments);
};
...
};if (!Module["ALLOC_NORMAL"]) Object.defineProperty(Module, "ALLOC_NORMAL", { get: function get() {
    abort("'ALLOC_NORMAL' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
  } });
if (!Module["ALLOC_STACK"]) Object.defineProperty(Module, "ALLOC_STACK", { get: function get() {
    abort("'ALLOC_STACK' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
  } });
if (!Module["ALLOC_STATIC"]) Object.defineProperty(Module, "ALLOC_STATIC", { get: function get() {
    abort("'ALLOC_STATIC' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
  } });
if (!Module["ALLOC_DYNAMIC"]) Object.defineProperty(Module, "ALLOC_DYNAMIC", { get: function get() {
    abort("'ALLOC_DYNAMIC' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
  } });
if (!Module["ALLOC_NONE"]) Object.defineProperty(Module, "ALLOC_NONE", { get: function get() {
